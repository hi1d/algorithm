...
#     three_nums = []
#     flag = 0
#     for i in range(len(nums)):  # 모든 세개의 합 구하기
...
def solution(nums):
    ...
    select_nums_count = len(nums) / 2
    diffrent_count = len(set(nums))
    if select_nums_count <= diffrent_count:
        answer = select_nums_count
    else:
        answer = diffrent_count
